...
| Module | Description |
|-----| ----- |
| [Embr Charts](/ignition/embr-charts) |  Adds enhanced charting capabilities to Ignition `Perspective`. |
| [Embr Periscope](/ignition/embr-periscope) | Push the boundaries of what's capable with Ignition `Perspective`. |
| [Embr Thermodynamics](/ignition/embr-thermodynamics) | Simplify complex thermodynamic calculations and modeling. |
